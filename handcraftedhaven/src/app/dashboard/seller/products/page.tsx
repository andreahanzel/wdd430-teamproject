      ...
      <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-700 p-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[...Array(3)].map((_, i) => (
              <div key={i} className="bg-white/10 backdrop-blur-lg rounded-xl shadow-xl p-6 h-96 animate-pulse border border-white/10">
    ...
    <div id="main-content" className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-700 p-8">
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-10">
          <div>
            <h1 className="text-3xl md:text-4xl font-bold text-white mb-2">Your Products</h1>
            <p className="text-pink-200">Manage your handcrafted creations</p>
          </div>
          <Link href="/dashboard/seller/products/new">
            <Button 
              variant="primary" 
              className="bg-pink-600 hover:bg-pink-500 text-white flex items-center gap-2 py-2 px-5 rounded-lg shadow-lg transition duration-300 transform hover:scale-105"
            >
        ...
        {products.length === 0 ? (
          <div className="bg-white/10 backdrop-blur-lg rounded-xl shadow-xl p-10 border border-white/10 text-center">
            ...
            <h3 className="text-xl font-bold text-white mb-3">No products yet</h3>
            <p className="text-pink-100 mb-6">Add your first product to start selling your handcrafted creations</p>
            <Link href="/dashboard/seller/products/new">
              <Button 
                variant="primary"
                className="bg-pink-600 hover:bg-pink-500 text-white py-2 px-6 rounded-lg shadow-lg transition duration-300 transform hover:scale-105"
                  ...
                  <div className="flex justify-between">
                    <Link href={`/dashboard/seller/products/edit/${product.id}`}>
                      <Button 
                        variant="secondary" 
                        size="sm"
                        className="bg-indigo-600/40 hover:bg-indigo-500/40 text-white backdrop-blur-sm border border-indigo-400/20 transition duration-300 transform hover:scale-105"
                      >
