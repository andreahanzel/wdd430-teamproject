...
import { 
    ...
    export default function OrderDetailPage() {
        ...
        return (
            <section id="main-content" className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-700 p-8">
                {/* Add print styles */}
                <style jsx global>{`
                    @media print {
                        body {
                            background: #4338ca !important;
                            background-image: linear-gradient(to bottom right, #4338ca, #581c87, #be185d) !important;
                        ...
                        /* Ensure the full order detail is visible */
                        .min-h-screen {
                        ...
                        /* Additional support for print styles */
                        body.is-printing {
                            -webkit-print-color-adjust: exact !important;
                            print-color-adjust: exact !important;
                        }
