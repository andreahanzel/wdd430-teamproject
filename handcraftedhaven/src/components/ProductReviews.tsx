...
export default function ProductReviews({ productId }: ProductReviewsProps) {
    ...
    const productReviews: Review[] = reviews.filter((r) => r.productId === productId);

    // Calculate average rating (move this to product detail page)
    ...
    return (
        ...
        <h2 className="text-2xl font-bold text-darkPurple mb-6">Customer Reviews</h2>
