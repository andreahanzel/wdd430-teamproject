...
export default function LoginForm() {
    ...
    return (
        <div className="login-backdrop bg-white/10 border border-white/10 rounded-xl shadow-xl p-8 sm:p-10 text-white">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="relative">
                    ...
                    className="ios-input w-full pl-10 pr-3 py-2 bg-white/10 border border-white/20 rounded-lg text-white placeholder-pink-200/70 focus:outline-none focus:ring-2 focus:ring-pink-500/50 focus:border-transparent transition duration-300"
                    />
                </div>
                </div>
                ...
                <div className="relative">
                    ...
                    placeholder="••••••••"
                    minLength={6}
                    className="ios-input w-full pl-10 pr-10 py-2 bg-white/10 border border-white/20 rounded-lg text-white placeholder-pink-200/70 focus:outline-none focus:ring-2 focus:ring-pink-500/50 focus:border-transparent transition duration-300"
                    />
                    <button
                    type="button"
